...
public class ProgramExecutor {
    ...
    //The program counter. Can be incremented, decremented, or taken by the user.
    public int _pc = 0;
    ...
    // Whether or not we are currently in a comment.
    // Opcode '(' enters a comment once encountered, and we stay in a comment
    // until ')' is encountered.
    public boolean _inCommentMode = false;
    ...
    public void executeInstruction(char c) {
        ...
        try {
            ...
            // Checks if currently in comment. If in comment and the end comment operator
            // is encountered, verify comment will exit comment mode.
            if (verifyComment(c)) {
                return;
            }
            ...
            switch (c) {
                ...
                // r	Reverses the entire stack
                case 'r':
                    reverse();
                    break;

                //	i	Increments program counter.
                case 'i':
                    incrementCounter();
                    break;
                //	d	Decrements program counter.
                case 'd':
                    decrementCounter();
                    break;
                //	t   Takes program counter. Outputs counter to stack.
                case 't':
                    takeCounter();
                    break;

                //	(	Enter a comment until ')' is encountered.
                case '(':
                    enterComment();
                    break;

                //	)	Leave a comment if in one.
                case ')':
                    leaveComment();
                    break;
    ...
    /**
     * (    Enables comment mode and all text area input is ignored.
     */
    ...
    /**
     * )    Disables comment mode and re-enables text area input recognition.
     */
    ...
    /**
     * Checks to see if comment mode is currently enabled. If enabled, also checks to see if
     * it should be disabled.
     * @param c     currently char from text area. Used to check if comment mode should be exited.
     * @return      true if _inCommentMode, false otherwise.
     */
    public boolean verifyComment(char c) {
        if (_inCommentMode) {
    ...
    /**
     * i	Increment the program counter.
     */
    ...
    /**
     * d	Decrement the program counter.
     */
    ...
    /**
     * t	Take the program counter. Counter is pushed to stack.
     */
